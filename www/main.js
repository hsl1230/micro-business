...
/* harmony import */ var _providers_user_data_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./providers/user-data.service */ "./src/app/providers/user-data.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    function AppComponent(events, menu, platform, router, splashScreen, statusBar, storage, userData) {
        this.events = events;
        this.menu = menu;
    ...
    AppComponent.prototype.logout = function () {
        ...
        this.userData.logout().then(function () {
            return _this.navigate('/app/tabs/(schedule:schedule)');
        });
    };
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Events"],
            ...
            _providers_user_data_service__WEBPACK_IMPORTED_MODULE_6__["UserDataService"]])
    ], AppComponent);
    return AppComponent;
}());
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"], _ionic_storage__WEBPACK_IMPORTED_MODULE_6__["IonicStorageModule"].forRoot()],
            providers: [
...
/***/ "./src/app/providers/user-data.service.ts":
/*!************************************************!*\
  !*** ./src/app/providers/user-data.service.ts ***!
  \************************************************/
...
var UserDataService = /** @class */ (function () {
    function UserDataService(events, storage) {
        this.events = events;
        this.storage = storage;
        this._favorites = [];
    }
    UserDataService.prototype.hasFavorite = function (sessionName) {
        return (this._favorites.indexOf(sessionName) > -1);
    };
    UserDataService.prototype.addFavorite = function (sessionName) {
        this._favorites.push(sessionName);
    };
    UserDataService.prototype.removeFavorite = function (sessionName) {
        var index = this._favorites.indexOf(sessionName);
        if (index > -1) {
            this._favorites.splice(index, 1);
        }
    };
    UserDataService.prototype.login = function (username) {
        var _this = this;
        return this.storage.set(HAS_LOGGED_IN, true).then(function () {
            _this.setUsername(username);
            return _this.events.publish('user:login');
        });
    };
    UserDataService.prototype.signup = function (username) {
        var _this = this;
        return this.storage.set(HAS_LOGGED_IN, true).then(function () {
            _this.setUsername(username);
    ...
    UserDataService.prototype.logout = function () {
        var _this = this;
        return this.storage.remove(HAS_LOGGED_IN).then(function () {
    ...
    UserDataService.prototype.isLoggedIn = function () {
        return this.storage.get(HAS_LOGGED_IN).then(function (value) {
            return value === true;
        });
    };
    UserDataService.prototype.checkHasSeenTutorial = function () {
        return this.storage.get(HAS_SEEN_TUTORIAL).then(function (value) {
            return value;
        });
    };
...
module.exports = __webpack_require__(/*! /clientdata/github/ionic4/micro-business/src/main.ts */"./src/main.ts");
